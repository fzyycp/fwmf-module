...
import cn.faury.fwmf.module.service.menu.sqlProvider.MenuSQLProvider;
...
public interface MenuMapper {
	 ...
	 * @return 菜单信息
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "getMenuInfoByMenu")
	 ...
	 * @return 子菜单信息
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "getMenuChildInfoByMenu")
	@ResultType(MenuInfoBean.class)
	 ...
	 * 【可选】menuId 菜单id
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "getMenuInfoByMenuBean")
	@ResultType(MenuInfoBean.class)
	 ...
	 * 根据菜单ID查询菜单关联角色的数量
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "getMenuCountById")
	 ...
	 * @return 成功更新条数
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "updateMenuInfoById")
	 ...
	 * @return 成功删除条数
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "deleteMenuInfoById")
	 ...
	 * @return 成功删除条数
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "deleteMenuFuncInfoById")
	 ...
	 * @return 菜单列表
	 */
	@SelectProvider(type = MenuSQLProvider.class, method = "getMenuTowChildInfoByMenu")
	@ResultType(MenuInfoBean.class)
