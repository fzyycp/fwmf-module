...
public interface SchoolInfoGenerateMapper {
     ...
     */
    @Insert({
        "insert into sys_t_school_info (SCHOOL_NAME, SCHOOL_SHORTNAME, ",
        ...
        "values (#{schoolName,jdbcType=VARCHAR}, #{schoolShortname,jdbcType=VARCHAR}, ",
        ...
        "#{contactName,jdbcType=VARCHAR}, #{telNo,jdbcType=VARCHAR}, ",
        "#{address,jdbcType=VARCHAR}, #{isDelete,jdbcType=CHAR}, ",
        "#{pkg,jdbcType=VARCHAR}, #{createPerson,jdbcType=VARCHAR}, ",
    ...
    SchoolInfoGenerateBean selectByPrimaryKey(Long schoolId);
