...
public interface OrderInfoGenerateMapper {
    ...
    @Insert({
        ...
        "RECEIVER_NAME, TEL_NO, ",
        "CODE_NUMBER, CODE_URL, ",
        "REMARK, TRAD_STATE, ",
        ...
        "#{receiverName,jdbcType=VARCHAR}, #{telNo,jdbcType=VARCHAR}, ",
        "#{codeNumber,jdbcType=VARCHAR}, #{codeUrl,jdbcType=VARCHAR}, ",
        "#{remark,jdbcType=VARCHAR}, #{tradState,jdbcType=CHAR}, ",
    ...
    @Select({
        ...
        "CREATE_TIME, EXPIRED_TIME, UPDATE_PERSON, UPDATE_TIME, RECEIVER_NAME, TEL_NO, ",
        "CODE_NUMBER, CODE_URL, REMARK, TRAD_STATE, SHOP_ID, STORE_ID, AGENT_USER_ID, ",
        "IS_PICKUP, EXPRESS_CODE, EXPRESS_NAME, EXPRESS_FEE, TRACK_NUMBER, PAY_REMARK, ",
        "PAY_UPDATE_PERSON, PAY_UPDATE_TIME, REFOUND_STATE, INVOICE, PAY_TIME, SEND_TIME, ",
        "CONFIRM_TIME, IS_GROUP_BUY, IS_REFUND, IS_APP_ORDER",
