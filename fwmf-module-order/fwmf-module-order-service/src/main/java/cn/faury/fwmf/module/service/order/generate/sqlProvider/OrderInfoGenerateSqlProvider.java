...
public class OrderInfoGenerateSqlProvider {
    ...
    public String search(Map<String, Object> params) {
        ...
        sql.SELECT("CREATE_TIME, UPDATE_PERSON, UPDATE_TIME, RECEIVER_NAME, TEL_NO, CODE_NUMBER, CODE_URL");
        sql.SELECT("DEMO, TRAD_STATE, SHOP_ID, STORE_ID, AGENT_USER_ID, IS_PICKUP, EXPRESS_CODE, EXPRESS_NAME");
        sql.SELECT("EXPRESS_FEE, TRACK_NUMBER, PAY_REMARK, PAY_UPDATE_PERSON, PAY_UPDATE_TIME, REFOUND_STATE");
        sql.SELECT("INVOICE, PAY_TIME, SEND_TIME, CONFIRM_TIME, IS_GROUP_BUY, IS_REFUND, IS_APP_ORDER");
