...
public class OrderInfoGenerateSqlProvider {
    ...
    public String insertSelective(OrderInfoGenerateBean record) {
        ...
        if (record.getTradeState() != null) {
            sql.VALUES("TRADE_STATE", "#{tradeState,jdbcType=CHAR}");
        }
        ...
        if (record.getPayUpdatePerson() != null) {
            sql.VALUES("PAY_UPDATE_PERSON", "#{payUpdatePerson,jdbcType=BIGINT}");
        }
        
        if (record.getPayUpdatePersonName() != null) {
            sql.VALUES("PAY_UPDATE_PERSON_NAME", "#{payUpdatePersonName,jdbcType=VARCHAR}");
        }
        ...
        if (record.getConfirmClosingTime() != null) {
            sql.VALUES("CONFIRM_CLOSING_TIME", "#{confirmClosingTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getDelayedReceiveCount() != null) {
            sql.VALUES("DELAYED_RECEIVE_COUNT", "#{delayedReceiveCount,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(OrderInfoGenerateBean record) {
        ...
        if (record.getTradeState() != null) {
            sql.SET("TRADE_STATE = #{tradeState,jdbcType=CHAR}");
        }
        ...
        if (record.getPayUpdatePerson() != null) {
            sql.SET("PAY_UPDATE_PERSON = #{payUpdatePerson,jdbcType=BIGINT}");
        }
        
        if (record.getPayUpdatePersonName() != null) {
            sql.SET("PAY_UPDATE_PERSON_NAME = #{payUpdatePersonName,jdbcType=VARCHAR}");
        }
        ...
        if (record.getConfirmClosingTime() != null) {
            sql.SET("CONFIRM_CLOSING_TIME = #{confirmClosingTime,jdbcType=TIMESTAMP}");
        }
        
        if (record.getDelayedReceiveCount() != null) {
            sql.SET("DELAYED_RECEIVE_COUNT = #{delayedReceiveCount,jdbcType=INTEGER}");
        }
    ...
    public String search(Map<String, Object> params) {
        ...
        sql.SELECT("CREATE_TIME, EXPIRED_TIME, UPDATE_PERSON, UPDATE_PERSON_NAME, UPDATE_TIME, RECEIVER_NAME");
        sql.SELECT("TEL_NO, CODE_NUMBER, CODE_URL, REMARK, TRADE_STATE, SHOP_ID, STORE_ID, AGENT_USER_ID");
        sql.SELECT("IS_PICKUP, EXPRESS_CODE, EXPRESS_NAME, EXPRESS_FEE, TRACK_NUMBER, PAY_REMARK, PAY_UPDATE_PERSON");
        sql.SELECT("PAY_UPDATE_PERSON_NAME, PAY_UPDATE_TIME, REFOUND_STATE, INVOICE, PAY_TIME, SEND_TIME");
        sql.SELECT("CONFIRM_TIME, CONFIRM_CLOSING_TIME, DELAYED_RECEIVE_COUNT, IS_GROUP_BUY, IS_REFUND");
        ...
        if (params.get("tradeState") != null){
            if (!(params.get("tradeState") instanceof String) || StringUtil.isNotEmpty((String) params.get("tradeState"))){
                sql.WHERE("TRADE_STATE=#{tradeState,jdbcType=CHAR}");
            }
        }
        if (params.get("tradeStateLike")!=null){
            if (!(params.get("tradeStateLike") instanceof String) || StringUtil.isNotEmpty((String) params.get("tradeStateLike"))){
                sql.WHERE("TRADE_STATE LIKE CONCAT('%',#{tradeStateLike,jdbcType=CHAR},'%')");
            }
        }
        ...
        if (params.get("payUpdatePerson") != null){
            if (!(params.get("payUpdatePerson") instanceof String) || StringUtil.isNotEmpty((String) params.get("payUpdatePerson"))){
                sql.WHERE("PAY_UPDATE_PERSON=#{payUpdatePerson,jdbcType=BIGINT}");
            }
        }
        if (params.get("payUpdatePersonName") != null){
            if (!(params.get("payUpdatePersonName") instanceof String) || StringUtil.isNotEmpty((String) params.get("payUpdatePersonName"))){
                sql.WHERE("PAY_UPDATE_PERSON_NAME=#{payUpdatePersonName,jdbcType=VARCHAR}");
            }
        }
        if (params.get("payUpdatePersonNameLike")!=null){
            if (!(params.get("payUpdatePersonNameLike") instanceof String) || StringUtil.isNotEmpty((String) params.get("payUpdatePersonNameLike"))){
                sql.WHERE("PAY_UPDATE_PERSON_NAME LIKE CONCAT('%',#{payUpdatePersonNameLike,jdbcType=VARCHAR},'%')");
            }
        }
        ...
        if (params.get("confirmClosingTime") != null){
            if (!(params.get("confirmClosingTime") instanceof String) || StringUtil.isNotEmpty((String) params.get("confirmClosingTime"))){
                sql.WHERE("CONFIRM_CLOSING_TIME=#{confirmClosingTime,jdbcType=TIMESTAMP}");
            }
        }
        if (params.get("confirmClosingTimeStart")!=null){
            if (!(params.get("confirmClosingTimeStart") instanceof String) || StringUtil.isNotEmpty((String) params.get("confirmClosingTimeStart"))){
                sql.WHERE("CONFIRM_CLOSING_TIME >= #{confirmClosingTimeStart,jdbcType=TIMESTAMP}");
            }
        }
        if (params.get("confirmClosingTimeEnd")!=null){
            if (!(params.get("confirmClosingTimeEnd") instanceof String) || StringUtil.isNotEmpty((String) params.get("confirmClosingTimeEnd"))){
                sql.WHERE("CONFIRM_CLOSING_TIME <= #{confirmClosingTimeEnd,jdbcType=TIMESTAMP}");
            }
        }
        if (params.get("delayedReceiveCount") != null){
            if (!(params.get("delayedReceiveCount") instanceof String) || StringUtil.isNotEmpty((String) params.get("delayedReceiveCount"))){
                sql.WHERE("DELAYED_RECEIVE_COUNT=#{delayedReceiveCount,jdbcType=INTEGER}");
            }
        }
