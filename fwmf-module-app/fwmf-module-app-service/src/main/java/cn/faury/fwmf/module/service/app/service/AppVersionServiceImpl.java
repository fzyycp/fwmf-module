...
import cn.faury.fwmf.module.service.app.mapper.AppVersionMapper;
 ...
 *     当前服务实现了AppVersionService服务接口，用于项目业务代码扩展添加
 *     只需初始化生成一次，然后根据需要扩展，重新生成时注意合并自己添加的代码
 * </pre>
 */
public class AppVersionServiceImpl extends CrudBaseServiceImpl<AppVersionBean, Long> implements AppVersionService {
    ...
    public AppVersionServiceImpl(CommonDao commonDao) {
        super(commonDao, AppVersionMapper.class);
    }
