...
import cn.faury.fwmf.module.api.payment.generate.bean.AlipayRecordsGenerateBean;
 ...
 *
 * <pre>
 *     AlipayRecordsGenerateBean为数据库表自动生成POJO对象，不可修改
 *     当前POJO继承自AlipayRecordsGenerateBean，用于项目业务代码扩展添加
