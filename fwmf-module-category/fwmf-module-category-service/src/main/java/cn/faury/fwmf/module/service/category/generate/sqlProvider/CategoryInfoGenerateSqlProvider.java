...
public class CategoryInfoGenerateSqlProvider {
    ...
    public String search(Map<String, Object> params) {
        SQL sql = new SQL();
        sql.SELECT("PRODUCT_CATEGORY_ID, PRODUCT_CATEGORY_NAME, DISPLAY_ORDER, PARENT_ID, ICON, USAGE_CODE");
        ...
        if (params.get("icon") != null){
            if (!(params.get("icon") instanceof String) || StringUtil.isNotEmpty((String) params.get("icon"))){
                sql.WHERE("ICON=#{icon,jdbcType=VARCHAR}");
            }
        }
        if (params.get("iconLike")!=null){
            if (!(params.get("iconLike") instanceof String) || StringUtil.isNotEmpty((String) params.get("iconLike"))){
                sql.WHERE("ICON LIKE CONCAT('%',#{iconLike,jdbcType=VARCHAR},'%')");
            }
        }
