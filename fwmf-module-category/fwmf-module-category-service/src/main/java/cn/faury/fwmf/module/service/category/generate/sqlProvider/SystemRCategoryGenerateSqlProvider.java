...
public class SystemRCategoryGenerateSqlProvider {
     ...
     * @fwmf.generated 2018-11-14 17:14:30
     */
    public String insertSelective(SystemRCategoryGenerateBean record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("product_t_category_r_system");
     ...
     * @fwmf.generated 2018-11-14 17:14:30
     */
    public String updateByPrimaryKeySelective(SystemRCategoryGenerateBean record) {
        SQL sql = new SQL();
        sql.UPDATE("product_t_category_r_system");
    ...
    public String search(Map<String, Object> params) {
        SQL sql = new SQL();
        sql.SELECT("ID, SYSTEM_ID, PRODUCT_CATEGORY_ID, TEMPLATE_ID, IS_LEAF");
        
        sql.FROM("product_t_category_r_system");
        ...
        if (params.get("templateId") != null){
            if (!(params.get("templateId") instanceof String) || StringUtil.isNotEmpty((String) params.get("templateId"))){
                sql.WHERE("TEMPLATE_ID=#{templateId,jdbcType=BIGINT}");
            }
        }
